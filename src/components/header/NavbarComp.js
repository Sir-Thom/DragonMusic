...
const Navigation =({E})=> {
  ...
  return (
    <nav className="flex font-Ubuntu space-y-4 absolute mb-7 pb-4  w-full justify-center  z-[2000] justify-items-center shadow-xl  item-center  bg-cod-gray-700   py-4 ">
      ...
      >
        <HiUserCircle size={25} className="w-10 active:scale-90 hover:border-cod-gray-100 border-2 border-transparent  rounded-full transition ease-in-out h-10 text-gray-600" />
