...
export default  function SearchBar(){
  ...
  function test(i){
    ...
    return(
        <div className=' flex '>
        <input type={"search"} onChange={(i) => test(i)} className="form-control rounded-full sm:w-36 md:w-76 lg:w-96 justify-items-end flex-row flex-auto min-w-0 block  px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  transition ease-in-out m-0 focus:text-gray-700  border-l-violet-600 focus:bg-white focus:border-violet-600 focus:outline-violet-600" 
